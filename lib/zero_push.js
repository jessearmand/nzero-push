...
function ZeroPush(authToken) {
  ...
  this.baseURL = "https://zeropush.pushwoosh.com/";
...
ZeroPush.prototype.notify = function (platform, requiredParams, optionalParams, callback) {
  ...
  if (!requiredParams || typeof requiredParams !== "object")
    return callback(new Error("Invalid required parameters"));
...
ZeroPush.prototype._notifySafariPlatform = function (requiredParams, optionalParams, callback) {
  ...
  body = {
    device_tokens: requiredParams.device_tokens,
    title: requiredParams.title,
    body: requiredParams.body
  };
...
ZeroPush.prototype.register = function (requiredParams, optionalParams, callback) {
  ...
  if ((!requiredParams || typeof requiredParams !== "string") && !util.isArray(requiredParams))
    return callback(new Error("Invalid required parameter"));

  if (typeof optionalParams === "function")
    callback = optionalParams;

  if ((!optionalParams || typeof optionalParams !== "string") && !util.isArray(optionalParams))
    return callback(new Error("Invalid optional parameter"));
...
ZeroPush.prototype._setBadgeForOneDevice = function (requiredParams, callback) {
  ...
  body = {
    device_token: requiredParams.device_token,
    badge: requiredParams.badge
  };
...
ZeroPush.prototype.devices = function (optionalParams, callback) {
  debug("ENDPOINT: /devices");
  ...
  async.waterfall(
    [
      ...
      function (next) {
        ...
        self._devices(optionalParams, next);
      }
    ],
    callback
  );
...
ZeroPush.prototype._devices = function (optionalParams, callback) {
  debug("PRIVATE ENDPOINT: devices");

  var self = this;
  var requestURL;
  var options;

  requestURL = this.baseURL + ENDPOINTS.devices;
  options = clone(this.baseRequestOptions);
  ...
  if (typeof optionalParams !== "function" && typeof optionalParams === "object") {
    if (optionalParams.page)
      options.url += "&page=" + optionalParams.page;

    if (optionalParams.per_page)
      options.per_page += "&per_page=" + optionalParams.per_page;
  }
...
ZeroPush.prototype.channels = function (optionalParams, callback) {
  debug("ENDPOINT: /channels");
  ...
  async.waterfall(
    [
      ...
      function (next) {
        ...
        self._channels(optionalParams, next);
      }
    ],
    callback
  );
...
ZeroPush.prototype._channels = function (optionalParams, callback) {
  debug("PRIVATE ENDPOINT: channels");

  var self = this;
  var requestURL;
  var options;

  requestURL = this.baseURL + ENDPOINTS.channels;
  options = clone(this.baseRequestOptions);
...
ZeroPush.prototype._subscribeDevices = function (requiredParams, callback) {
  ...
  if (!util.isArray(requiredParams.channel)) {
    requestURL = this.baseURL + ENDPOINTS.subscribe;
    ...
    return async.each(
      ...
      function (device, next) {
        body = {
          device_token: device,
          channel: requiredParams.channel
        };
...
ZeroPush.prototype._subscribeDevice = function (requiredParams, callback) {
  ...
  if (!util.isArray(requiredParams.channel)) {
    ...
    options.url = requestURL;
    body.channel = requiredParams.channel;
    options.body = JSON.stringify(body);
...
ZeroPush.prototype._broadcastIosAndMacPlatform = function (requiredParams, optionalParams, callback) {
  ...
  if (typeof optionalParams === "object" && optionalParams.channel && !util.isArray(optionalParams.channel)) {
    ...
    body.channel = optionalParams.channel;
    options.body = JSON.stringify(body);
...
ZeroPush.prototype._verifyCredentials = function (callback) {
  ...
  executeRequest(
    ...
    function (err, body, headers) {
      ...
      self.authenticated = (body.message === "authenticated") ? true : false;
      callback();
    }
  );
};
